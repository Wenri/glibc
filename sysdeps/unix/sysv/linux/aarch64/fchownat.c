/* fchownat -- Linux implementation, written so the android port can rename it.
...
#if !IS_IN (rtld)
# define fchownat __android_next_fchownat
...
# define __NR___android_next_fchownat __NR_fchownat
#endif

int
fchownat (int fd, const char *file, uid_t owner, gid_t group, int flag)
{
  return INLINE_SYSCALL_CALL (fchownat, fd, file, owner, group, flag);
}
